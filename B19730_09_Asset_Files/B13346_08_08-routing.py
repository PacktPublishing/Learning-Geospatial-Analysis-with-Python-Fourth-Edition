...
# https://github.com/PacktPublishing/Learning-Geospatial-Analysis-with-Python-4th-Edition/raw/main/B19730_09_Asset_Files/routing.zip
...
sg = G_undirected.subgraph(connected_components[0])
