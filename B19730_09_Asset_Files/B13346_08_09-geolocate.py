...
# https://github.com/PacktPublishing/Learning-Geospatial-Analysis-with-Python-4th-Edition/raw/main/B19730_09_Asset_Files/photos.zip
...
def gps(exif):
    """Extract GPS info from EXIF metadata"""
    lat = None
    lon = None
    if exif['GPSInfo']:        
        # Lat
